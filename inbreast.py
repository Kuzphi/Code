...
def readdicom(mydict):
  ...
  mydict is the returned value of readlabel'''
	...
	for f in img_fnames:
		...
		with open(join(preprocesspath, names[0])+'.pickle', 'wb') as outfile:
...
dreampreprocesspath = '../dockerdream/preprocessedData/'
dreamcsv1 = '../dockerdream/metadata/images_crosswalk.tsv'
dreamcsv2 = '../dockerdream/metadata/exams_metadata.tsv'
